...
class Fingerprint(nn.Module):
    ...
    def forward(self,atom_list=None,bond_list=None,atom_degree_list=None,bond_degree_list=None,atom_mask=None,output_feature=False,feature_only=False,feature1=None,feature2=None,shared=False,d=0):
        if feature_only:
            if shared:
